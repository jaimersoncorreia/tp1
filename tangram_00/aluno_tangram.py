...
def compor_cena_ex3(c):
    ...
    glPushMatrix()
    glTranslate(-2,2,0)
    glTranslate(-2,2*sin(-135*pi/180),0)
    glRotate(-45,0,0,1)
    glTranslate(0,2,0)
    c.draw("TM")
    glPopMatrix()
    ...
    glPushMatrix()
    glTranslate(-2,2*sin(225*pi/180),0)
    glTranslate(1,1,0)
    c.draw("Q")
    glPopMatrix()
...
def compor_cena_ex4(c):
    ...
    glPushMatrix()
    glTranslate(cos(45*pi/180),sin(45*pi/180),0)
    glTranslate(6*cos(135*pi/180),6*sin(135*pi/180),0)
    glRotate(135,0,0,1)
    glTranslate(1,1,0)
    c.draw("TP2")
    glPopMatrix()
...
def compor_cena_ex5(c):
    ...
    glPushMatrix()
    glTranslate(6*cos(45*pi/180),6*sin(45*pi/180),0)
    glRotate(225,0,0,1)
    glTranslate(1,-1,0)
    c.draw("TP1")
    glPopMatrix()
